...
export const memberships = pgTable("memberships", {
  ...
  pk: primaryKey({ columns: [table.userId, table.orgId], name: "pk_memberships" }),
}));
...
export const endpoints = pgTable("endpoints", {
  ...
  pathMethodUnique: unique("uq_endpoint_api_path_method").on(table.apiId, table.path, table.method),
}));
...
export const openapiSpecs = pgTable("openapi_specs", {
  ...
  apiVersionUnique: unique("uq_openapi_api_version").on(table.apiId, table.version),
}));
...
export const featureFlags = pgTable("feature_flags", {
  ...
  planFeatureUnique: unique("uq_feature_flag_plan_feature").on(table.plan, table.featureKey),
}));
