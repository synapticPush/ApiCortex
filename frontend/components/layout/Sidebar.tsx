    ...
    <div className={cn(
      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-[#242938]">
        <div className="flex items-center gap-3 overflow-hidden">
          ...
          {!isCollapsed && <span className="font-bold text-xl text-[#E6EAF2] tracking-tight whitespace-nowrap">ApiCortex</span>}
        </div>
        {!isCollapsed && (
          <button 
              ...
              >
                ...
                <item.icon 
                  className={cn(
                    ...
                    isActive ? "text-[#3A8DFF]" : "text-[#9AA3B2] group-hover:text-[#E6EAF2]"
                  )} 
                />
