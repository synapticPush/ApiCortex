  ...
  return (
    <div className="min-h-screen bg-[#0F1117] text-[#E6EAF2] font-sans selection:bg-[#5B5DFF]/30 overflow-hidden">
      ...
      <nav className="relative z-50 border-b border-[#242938]/50 bg-[#0F1117]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl tracking-tight text-white">ApiCortex</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#9AA3B2]">
            <Link href="#features" className="hover:text-white transition-colors">Features</Link>
            <Link href="#how-it-works" className="hover:text-white transition-colors">How it Works</Link>
            <Link href="#dev-experience" className="hover:text-white transition-colors">Developers</Link>
            <Link href="#" className="hover:text-white transition-colors">Documentation</Link>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/login" className="text-sm font-medium text-[#9AA3B2] hover:text-white transition-colors">
              Sign In
            </Link>
            <Link href="/login">
      ...
      <main className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="inline-flex flex-row items-center justify-center p-1 rounded-full bg-[#161A23] border border-[#242938] mb-8 pr-4">
                <span className="px-3 py-1 text-xs font-semibold bg-[#5B5DFF] text-white rounded-full mr-3 shadow-[0_0_10px_rgba(91,93,255,0.5)]">New</span>
                <span className="text-sm text-[#9AA3B2]">Machine Learning Anomaly Detection is live</span>
              </div>
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold tracking-tight leading-[1.1] mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-[#E6EAF2] to-[#9AA3B2]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5B5DFF] to-[#00C2A8]">Production.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="#">
                  <Button variant="outline" className="h-14 px-8 border-[#242938] bg-[#161A23]/50 backdrop-blur-xl hover:bg-[#242938] text-white rounded-full font-medium text-lg w-full sm:w-auto transition-all">
                    View Documentation
                  </Button>
                </Link>
              </div>
              ...
              <div className="relative w-full max-w-lg aspect-square">
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-white">Live Traffic Analysis</h3>
                        <p className="text-xs text-[#00C2A8]">Processing 42.1k req/s</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0F1117] rounded-xl p-4 font-mono text-xs text-[#9AA3B2] space-y-2 relative overflow-hidden">
                    ...
                    <div className="flex justify-between">
                      <span className="text-[#3A8DFF]">PATCH /api/v1/profile</span>
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs font-semibold text-white">Anomaly Detected</span>
                  </div>
                  <div className="h-10 w-full bg-gradient-to-r from-[#242938] via-[#FF5C5C]/20 to-[#242938] rounded opacity-50 relative overflow-hidden">
                     <svg className="w-full h-full" viewBox="0 0 100 20" preserveAspectRatio="none">
                       <path d="M0,10 L20,10 L30,5 L40,15 L50,10 L60,10 L70,18 L80,2 L90,10 L100,10" fill="none" stroke="#FF5C5C" strokeWidth="2" />
                     </svg>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-semibold text-white">Contract Verified</span>
                      <span className="text-xs text-[#9AA3B2]">No breaking changes</span>
                    </div>
                  </div>
                </motion.div>
        ...
        {/* Feature Section */}
        <section id="features" className="py-24 relative z-10 bg-[#0F1117]/50 backdrop-blur-3xl border-y border-[#242938]">
              ...
              {[
                {
                  ...
                  visual: (
                    <div className="h-full w-full bg-[#161A23] rounded-lg border border-[#242938] overflow-hidden relative p-4 flex items-end">
                       <div className="absolute top-4 left-4 text-xs font-mono text-[#9AA3B2]">Failure Probability: <span className="text-[#FF5C5C]">84%</span></div>
                       <div className="w-full flex items-end gap-1 h-20">
                          {[20, 30, 25, 40, 35, 60, 85, 90, 40].map((h, i) => (
                            <div key={i} className={`w-full rounded-t-sm transition-all ${h > 70 ? 'bg-[#FF5C5C]' : 'bg-[#5B5DFF]'}`} style={{ height: `${h}%` }} />
                          ))}
                       </div>
                    </div>
                  )
                  ...
                  visual: (
                    <div className="h-full w-full bg-[#161A23] rounded-lg border border-[#242938] p-4 flex flex-col gap-2 font-mono text-xs">
                       <div className="flex gap-2">
                         <span className="bg-[#242938] text-[#3A8DFF] px-2 py-1 rounded">GET</span>
                         <span className="bg-[#0F1117] border border-[#242938] text-[#E6EAF2] px-2 py-1 rounded flex-1 truncate">api.acme.com/users</span>
                       </div>
                  ...
                  visual: (
                    <div className="h-full w-full bg-[#161A23] rounded-lg border border-[#242938] p-4 font-mono text-[10px] sm:text-xs">
                       <div className="flex justify-between mb-2">
                         <span className="text-[#9AA3B2]">Expected (OpenAPI)</span>
                  ...
                  visual: (
                    <div className="h-full w-full bg-[#161A23] rounded-lg border border-[#242938] p-4 relative overflow-hidden group">
                       <svg className="w-full h-full" viewBox="0 0 100 40" preserveAspectRatio="none">
                         <path d="M0,30 Q25,10 50,20 T100,5" fill="none" stroke="#F5B74F" strokeWidth="2" className="opacity-50 group-hover:opacity-100 transition-opacity" />
                         <path d="M0,40 L0,30 Q25,10 50,20 T100,5 L100,40 Z" fill="url(#gradient-orange)" stroke="none" className="opacity-20" />
                         <defs>
                           <linearGradient id="gradient-orange" x1="0" y1="0" x2="0" y2="1">
                             <stop offset="0%" stopColor="#F5B74F" />
                             <stop offset="100%" stopColor="#161A23" stopOpacity={0} />
                           </linearGradient>
                         </defs>
                       </svg>
                    </div>
                ...
                <div key={i} className="group relative bg-[#161A23] border border-[#242938] rounded-3xl p-8 hover:border-[#5B5DFF]/50 transition-colors overflow-hidden flex flex-col h-[350px]">
                  <div className={`absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl ${feature.color} to-transparent opacity-5 rounded-full blur-3xl group-hover:opacity-20 transition-opacity`} />
                  ...
                  <p className="text-[#9AA3B2] mb-8 relative z-10 flex-1">{feature.desc}</p>
        ...
        <section id="how-it-works" className="py-24 relative z-10">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row items-start justify-between relative">
              ...
              {[
                { step: "01", title: "Connect APIs", desc: "Upload OpenAPI specs or integrate live telemetry feeds.", icon: <Database className="w-6 h-6" /> },
                { step: "02", title: "Analyze Traffic", desc: "ApiCortex processes telemetry and extracts patterns.", icon: <Activity className="w-6 h-6" /> },
                { step: "03", title: "Predict Risk", desc: "ML models detect anomalies and forecast failures.", icon: <Cpu className="w-6 h-6" /> },
                { step: "04", title: "Act Promptly", desc: "Get alerts and fix issues before users notice.", icon: <Zap className="w-6 h-6" /> }
              ].map((item, i) => (
                <div key={i} className="relative z-10 flex flex-col items-center text-center w-full md:w-1/4 px-4 mb-12 md:mb-0">
                  <div className="w-24 h-24 rounded-full bg-[#0F1117] border-2 border-[#242938] flex flex-col items-center justify-center mb-6 shadow-xl relative overflow-hidden group">
                     ...
                     <div className="text-[#5B5DFF] mb-1 relative z-10">{item.icon}</div>
                     <span className="text-[#9AA3B2] font-mono text-xs relative z-10">Step {item.step}</span>
                  </div>
        ...
        {/* Developer Experience / API Testing Mockup */}
        <section id="dev-experience" className="py-24 relative z-10 bg-gradient-to-b from-[#0F1117] to-[#161A23] border-t border-[#242938]">
          <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="h-10 border-b border-[#242938] bg-[#161A23] flex items-center px-4 gap-2">
                ...
                <div className="ml-4 flex-1 text-center text-xs font-mono text-[#9AA3B2]">ApiCortex Testing Kit</div>
              </div>
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4 h-[400px]">
                ...
                <div className="bg-[#161A23] border border-[#242938] rounded-xl flex flex-col">
                  <div className="p-3 border-b border-[#242938] flex gap-2">
                    <span className="bg-[#5B5DFF] text-white px-2 py-1 rounded text-xs font-bold">POST</span>
                    <span className="bg-[#0F1117] border border-[#242938] text-white px-2 py-1 rounded text-xs font-mono flex-1 truncate">/api/v2/charge</span>
                  </div>
  ...
  "source": "tok_visa"
                ...
                <div className="bg-[#161A23] border border-[#242938] border-r-4 border-r-[#2ED573] rounded-xl flex flex-col relative overflow-hidden">
                  <div className="p-3 border-b border-[#242938] flex justify-between items-center bg-[#2ED573]/5">
                    <span className="text-[#2ED573] font-bold text-xs">200 OK</span>
                    <span className="text-[#9AA3B2] text-[10px] font-mono">142ms</span>
                  </div>
                  <div className="flex-1 p-3">
...
{`{
  ...
  "status": "succeeded"
            ...
            <div className="space-y-8">
              <h2 className="text-3xl md:text-5xl font-bold text-white">Built for Developers</h2>
              <p className="text-[#9AA3B2] text-lg">
              ...
              <Button className="mt-4 bg-transparent border border-[#5B5DFF] text-[#5B5DFF] hover:bg-[#5B5DFF]/10 h-12 px-6 rounded-full group">
                 Explore the Docs <ChevronRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
            </div>
        ...
        <section className="py-20 border-t border-[#242938] bg-[#0F1117]">
          <div className="max-w-7xl mx-auto px-6 text-center">
            <p className="text-sm font-semibold text-[#9AA3B2] tracking-widest uppercase mb-10">Trusted by Engineering Teams at</p>
            <div className="flex flex-wrap justify-center gap-12 sm:gap-24 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              {/* Fake Logos for visually striking presence */}
              <div className="text-2xl font-bold text-white flex items-center gap-2"><div className="w-6 h-6 bg-white rounded-sm drop-shadow-md" /> Acme Corp</div>
              <div className="text-2xl font-bold text-white flex items-center gap-2"><div className="w-6 h-6 rounded-full border-[4px] border-white" /> GlobalNet</div>
              <div className="text-2xl font-bold text-white flex items-center gap-2"><Network className="w-6 h-6" /> DataSystem</div>
              <div className="text-2xl font-bold text-white flex items-center gap-2"><Lock className="w-6 h-6" /> SecureAPI</div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
            <h2 className="text-4xl md:text-6xl font-black text-white leading-tight mb-6">
              Stop Guessing.<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5B5DFF] to-[#00C2A8]">Start Predicting API Failures.</span>
            </h2>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-[#9AA3B2]">Free tier available. No credit card required.</p>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="border-t border-[#242938] bg-[#0F1117] pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
            <div className="col-span-2 lg:col-span-2">
              ...
              <p className="text-[#9AA3B2] text-sm max-w-xs leading-relaxed">
                The intelligence layer for your API infrastructure. Predicting failures, testing contracts, and analyzing telemetry at scale.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-[#9AA3B2]">
                <li><Link href="#" className="hover:text-white transition-colors">API Testing</Link></li>
                <li><Link href="#" className="hover:text-white transition-colors">Telemetry</Link></li>
                <li><Link href="#" className="hover:text-white transition-colors">Predictions</Link></li>
          ...
          <div className="border-t border-[#242938] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-[#9AA3B2] text-sm">© 2026 ApiCortex, Inc. All rights reserved.</p>
...
// Add fake icon component for the Globe since it isn't imported from Lucide at top level (using a workaround)
